...
import be.ugent.zeus.hydra.data.network.minerva.models.Announcements;
...
import be.ugent.zeus.hydra.data.network.minerva.AnnouncementsRequest;
import be.ugent.zeus.hydra.data.network.minerva.WhatsNewRequest;
 ...
 */
public class AnnouncementAdapter extends MinervaAdapter {

    private static final String TAG = "AnnouncementSyncAdapter";

    private AnnouncementDao dao;

    AnnouncementAdapter(Context context, boolean autoInitialize) {
