...
public abstract class AgendaMapper {
    ...
    public abstract AgendaItem convert(be.ugent.zeus.hydra.domain.minerva.AgendaItem item);
    ...
    public abstract be.ugent.zeus.hydra.domain.minerva.AgendaItem convert(AgendaItem item, Course courseInstance);
}