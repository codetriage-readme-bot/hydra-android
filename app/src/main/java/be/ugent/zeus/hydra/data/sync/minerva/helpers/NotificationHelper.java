...
public class NotificationHelper {
    ...
    private PendingIntent upIntentOne(Announcement announcement) {
        ...
        return TaskStackBuilder.create(context)
                ...
                .getPendingIntent(announcement.getId(), PendingIntent.FLAG_UPDATE_CURRENT);
    }
    ...
    public void showNotificationsFor(Course course, List<Announcement> announcements) {
        ...
        for (Announcement announcement : announcements) {
            ...
            bigTextStyle.setSummaryText(announcement.getLecturer().getName());
            ...
            manager.notify(course.getId(), announcement.getId(), builder.build());
        }
    }
     ...
     * @param announcements The announcements.
     */
    public static void cancel(NotificationManagerCompat manager, String courseId, Collection<Announcement> announcements) {
        for (Announcement announcement : announcements) {
            cancel(courseId, announcement.getId(), manager);
        }
    }
    ...
    public static void cancel(Announcement announcement, NotificationManagerCompat notificationManager) {
        cancel(announcement.getCourse(), announcement.getId(), notificationManager);
    }
     ...
     * @param announcementId      The ID of the announcement, see {@link Announcement#getId()}.
     * @param notificationManager The notification manager.
     */
     ...
     * @param notificationManager The notification manager.
     */
    private static void cancel(String course, int announcementId, NotificationManagerCompat notificationManager) {
        notificationManager.cancel(course, announcementId);
    }
}